      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 sm:px-8 lg:px-16 py-8 sm:py-12">
        ...
        <div className="space-y-8 sm:space-y-12">
          <section>
            ...
            <ul className="text-sm sm:text-base text-gray-700 list-disc pl-6 sm:pl-8 space-y-2 sm:space-y-4">
              <li><strong>Thông tin cá nhân</strong>: Họ tên, email, số điện thoại, thông tin ngân hàng (phục vụ cho việc nạp/hoàn tiền).</li>
              <li><strong>Thông tin đăng nhập</strong>: Tên người dùng, mật khẩu (được mã hoá).</li>
              <li><strong>Thông tin liên kết Facebook</strong>: ID trang Fanpage, nội dung tin nhắn, tên khách hàng tương tác.</li>
              <li><strong>Thông tin thanh toán</strong>: Lịch sử nạp tiền, số dư tài khoản, phương thức thanh toán.</li>
              <li><strong>Thông tin kỹ thuật</strong>: Địa chỉ IP, loại thiết bị, trình duyệt, nhật ký hoạt động.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-sm sm:text-base text-gray-700 mt-4 sm:mt-6">
