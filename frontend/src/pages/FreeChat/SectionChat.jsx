...
function SectionChat() {
  ...
  const industries = [
    ...
    },
    {
      ...
      pageFB: ["Happy Mom – Chăm sóc mẹ và bé"],
      products: [
        "Link Bảng Giá Dịch Vụ :",
    ...
    },
    {
      ...
      instructions: [
        ...
        "Luôn hỏi thêm thông tin để hiểu rõ nhu cầu khách hàng trước khi tư vấn.",
    ...
    },
    {
      ...
      pageFB: ["Trung Tâm Anh Ngữ Sunrise"],
      products: [
        "Link Bảng Giá Dịch Vụ :",
      ...
      instructions: [
        ...
        "Luôn hỏi thêm thông tin để hiểu nhu cầu học viên trước khi tư vấn.",
    ...
    },
    {
      ...
      instructions: [
        ...
        "Sau đó hỏi thêm các thông tin cần thiết để hỗ trợ xử lý: Vị trí Km hoặc địa điểm gần nhất trên tuyến cao tốc.",
        "Chiều hướng di chuyển của phương tiện. Mô tả sự cố hoặc tình huống đang xảy ra.",
    ...
    },
    {
      ...
      instructions: [
        ...
        "Chuyển cuộc hội thoại cho nhân viên khi khách hàng muốn huổ đơn hàng",
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 sm:px-8 lg:px-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {industries.map((industry, index) => (
              <div key={index} className="group bg-white border border-gray-100 rounded-2xl p-5 sm:p-8 text-center shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col justify-between">
                ...
                <div>
                  <div className="w-12 h-12 sm:w-14 sm:h-14 mx-auto mb-4 sm:mb-6 flex items-center justify-center rounded-xl bg-orange-50 group-hover:bg-orange-100 transition">
                    <img src={industry.image} alt={industry.title} className="w-10 h-10 sm:w-12 sm:h-12 object-cover rounded-full" />
                  </div>
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-4">{industry.title}</h3>
                ...
                <div className="mt-4 sm:mt-6 flex flex-col sm:flex-row justify-center gap-2 sm:gap-3">
                  <a
                    ...
                    className="px-4 sm:px-6 py-2 text-white bg-blue-600 rounded-full text-xs sm:text-sm font-semibold hover:bg-blue-700 transition"
                  >
                    Chat thử
                  </a>
                  <button
                    onClick={() => setSelectedIndustry(industry)}
                    className="px-4 sm:px-6 py-2 text-gray-900 border border-gray-300 rounded-full text-xs sm:text-sm font-semibold hover:bg-gray-100 transition cursor-pointer"
                  >
                    Xem thiết lập
                  </button>
                </div>
      ...
      {selectedIndustry && (
        <>
          ...
          <div className="fixed inset-x-0 bottom-0 sm:inset-y-4 sm:left-auto sm:right-6 sm:w-[460px] sm:h-auto bg-white shadow-2xl z-50 flex flex-col sm:rounded-xl transform transition-transform duration-300 max-h-[85vh] sm:max-h-none">
            <div className="relative p-4 sm:p-6 bg-gradient-to-r from-blue-900 to-indigo-800 text-white sm:rounded-t-xl">
              <button
                onClick={() => setSelectedIndustry(null)}
                className="absolute top-4 right-4 hover:scale-110 transition cursor-pointer p-1"
              >
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                <img
                  ...
                  alt=""
                  className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl shadow-lg"
                />
                <div className="flex-1 min-w-0">
                  <h2 className="text-lg sm:text-xl font-bold leading-tight truncate">
                    {selectedIndustry.title}
                  </h2>
                  <p className="text-xs sm:text-sm opacity-80 mt-1 line-clamp-2">
                    {selectedIndustry.description}
                  </p>
                  <span className="inline-block mt-2 sm:mt-3 px-2 sm:px-3 py-0.5 sm:py-1 text-xs bg-white/20 rounded-full">
                    AI Bot Template
                  </span>
                </div>
              </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 sm:space-y-6 bg-gray-50">
              {selectedIndustry.pageFB && (
                <div className="bg-white rounded-xl shadow-sm p-4 sm:p-5 border border-gray-100">
                  <h3 className="font-bold text-gray-900 mb-2 sm:mb-3 text-xs sm:text-sm uppercase tracking-wide">
                    Page Facebook
                  </h3>
                ...
                <div className="bg-white rounded-xl shadow-sm p-4 sm:p-5 border border-gray-100">
                  ...
                  <ol className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-700">
                    {selectedIndustry.instructions.map((item, i) => (
                      <li
                        key={i}
                        className="bg-blue-50 border border-blue-100 p-2 sm:p-3 rounded-xl whitespace-pre-line"
                      >
                        {item}
                      </li>
                    ))}
