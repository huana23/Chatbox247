            ...
            <div className="space-y-8">
              <div className="bg-gray-50 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                <h3 className="text-2xl font-semibold text-gray-900 mb-4">
                  ChatBot AI chuyên nghiệp như người thật
                </h3>
                <p className="text-lg text-gray-700">
                  ChatBot AI có thể giao tiếp với khách hàng tự nhiên, gần gũi, tạo ra trải nghiệm người dùng tuyệt vời và nâng cao sự hài lòng.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-lg text-gray-700">
                  ChatBot AI sẽ tự động phản hồi khách hàng ngay khi họ nhắn tin, giúp bạn luôn sẵn sàng phục vụ mà không cần can thiệp.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-lg text-gray-700">
                  Tin nhắn từ ChatBot AI rất giống với một người thật, giúp khách hàng cảm thấy thoải mái và dễ dàng tương tác.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-lg text-gray-700">
                  Nếu khách hàng không còn trả lời, ChatBot AI có thể tự động nhắn tin thúc giục, giữ liên lạc và tăng khả năng chốt đơn.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-lg text-gray-700">
                  Bạn có thể dễ dàng quản lý tin nhắn và bình luận từ khách hàng trên trang Facebook của bạn thông qua hệ thống ChatBot AI.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-lg text-gray-700">
                  ChatBot AI giúp bạn theo dõi và quản lý danh sách đơn hàng một cách dễ dàng, giúp bạn tiết kiệm thời gian và công sức.
                </p>
              </div>
            </div>
          </section>
