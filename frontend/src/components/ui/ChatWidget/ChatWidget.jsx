...
function ChatWidget() {
  ...
  return (
    <>
      {open && (
        <div className="fixed bottom-24 right-4 sm:right-6 w-[calc(100vw-32px)] sm:w-[360px] h-[520px] max-h-[70vh] bg-white shadow-2xl rounded-xl z-50 flex flex-col">
          ...
          <div className="p-3 border-t flex gap-2">
            ...
            <button
              onClick={sendMessage}
              className="bg-orange-500 text-white px-4 rounded hover:bg-orange-600 cursor-pointer"
            >
              Gửi
            </button>
          </div>
      ...
      <button
        ...
        className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 bg-orange-500 text-white cursor-pointer rounded-full px-4 sm:px-5 py-3 shadow-lg hover:shadow-xl transition z-50"
      >
        💬 Chat
      </button>
    </>
